...
* [ ] Disable guest user access by default. Add only the minimum number of accounts if needed, in conformance to an approved guest user policy and [secure sharing environment](https://docs.microsoft.com/en-us/microsoft-365/solutions/create-secure-guest-sharing-environment?view=o365-worldwide).
